...
from pokecable_room.data.items import equivalent_item_id, item_category, item_exists, item_name
...
from pokecable_room.data.unown_forms import gen3_unown_form
...
class Gen3Parser:
    ...
    def export_pokemon(self, location: str) -> PokemonPayload:
        ...
        return PokemonPayload(
            ...
            metadata={"location": location, "format": "gen3-party-v1", "layout": self._require_layout().name, "gender": summary.gender, "unown_form": summary.unown_form},
