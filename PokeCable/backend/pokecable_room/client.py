...
from pokecable_room.battle_export import canonical_team_to_battle_text, format_id_for_generation
    ...
    async with PokeCableNetworkClient(server_url) as network:
        ...
        while True:
            ...
            if message_type == "battle_request_action":
                ...
                action_text = ui.input_text("Acao de batalha (ex: move 1, switch 2, pass, forfeit)", "pass")
...
async def automated_or_prompted_battle(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        ui.print("Time de batalha:")
        ui.print(canonical_team_to_battle_text(canonical_objects, parser.get_generation()))
