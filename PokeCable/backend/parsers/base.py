...
from display import normalize_pokemon_display
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not payload["summary"]:
            payload["summary"] = {
                ...
                "unown_form": self.metadata.get("unown_form"),
            }
        if not payload["raw"]:
            payload["raw"] = {
...
class ParserNotImplemented:
    ...
    def list_inventory(self) -> list[InventoryEntry]:
        raise NotImplementedError("Inventario real sera implementado na fase da geracao correspondente.")
