...
def draw_action_menu(screen, fonts, selected):
    """Menu to choose between creating or joining a room"""
    title_f, body_f, small_f, tiny_f = fonts
    screen.fill(BG)
    rect(screen, PANEL, pygame.Rect(0, 0, SCREEN_W, HEADER_H))
    ...
    while running:
        ...
        if current_screen == "menu" and action:
            if action == "up":
                ...
                if menu_index == 0:
                    # Choose between creating or joining
            ...
            if action == "up":
                ...
                # Now proceed to enter room name
                current_screen = "enter_room_name"
                keyboard_index = 0
                keyboard_shift = False
                room_name = ""
        ...
        if current_screen == "menu":
            ...
            draw_action_menu(screen, fonts, menu_index)
