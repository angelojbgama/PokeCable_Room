...
SPECIES_NAMES_BY_NATIONAL: dict[int, str] = {species_id: f"Species #{species_id}" for species_id in range(1, 494)}
...
SPECIES_NAMES_BY_NATIONAL.update(
    {national_id: name for national_id, name in enumerate(_GEN1_GEN2_SPECIES_NAMES, start=1)}
)
...
try:
    from .gen4_static import GEN4_SPECIES_NAMES
except Exception:
    GEN4_SPECIES_NAMES = {}
SPECIES_NAMES_BY_NATIONAL.update(GEN4_SPECIES_NAMES)
...
GEN4_ID_TO_NATIONAL: dict[int, int] = {species_id: species_id for species_id in range(1, 494)}
NATIONAL_TO_GEN4_ID: dict[int, int] = dict(GEN4_ID_TO_NATIONAL)
