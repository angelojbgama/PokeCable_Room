...
OFFICIAL_EXTRAS: tuple[OfficialExtra, ...] = (
    ...
    OfficialExtra(
        ...
        target_system="bag_item",
        distribution_method="mystery_gift",
        source_notes="Official Old Sea Map distribution is limited to Japanese Emerald.",
    ...
    OfficialExtra(
        ...
        source_notes="Ruby/Sapphire Battle-e support; implemented separately from Emerald/FRLG facilities.",
    ),
    OfficialExtra(
